...
SELECT location,date, population, rolling_people_vaccinated, (rolling_people_vaccinated/population)*100 AS percent_vaccinated
FROM total_vac
ORDER BY 1,2;
...
--Percentage fully vaccinated by country
...
--Countries with Highest Percentage of Population Fully Vaccinated
